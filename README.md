  ...
  "repos": [
    {
      ...
      "repo":"https://github.com/dmccauley123/ansible_f5.git",
      "branch":"master",
      "skip":false,
      "skipinstall":true
    }
...
```
docker run -p 8080:80 -p 2222:22 --rm -it -v /Users/dmccauley/_F5/super-netops-ansible-container/user_repos.json:/tmp/user_repos.json -e SNOPS_GH_BRANCH=develop f5devcentral/f5-super-netops-container:develop-ansible
```
